...
export default function Posts() {
  const posts = [
    ...
    },
    {
      ...
      userImg:
        'https://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80',
      img: 'https://images.unsplash.com/photo-1660924197568-440cb5baa08e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHx0b3BpYy1mZWVkfDJ8NnNNVmpUTFNrZVF8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=60',
      caption: 'Thanks for your post',
    },
  ];
  return (
